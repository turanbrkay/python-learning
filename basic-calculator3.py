...
# While True: ( bu ifadeyle: Aksi belirtilmediği müddetçe çalışmaya devam et dedik )
while True:
    ...
    if islem == "q":
        ...
        break
    # burada eğer kullanıcı q basarsa break ile döngüyü durdur diyoruz. ( break= kırmak, kopmak)
    # hiç değişken atama olayına girmedik bu sayede
